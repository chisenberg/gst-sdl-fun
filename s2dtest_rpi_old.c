...
void load () {
	...
	img_1280 = S2D_CreateImage("media/640.png");
		screen = S2D_CreateImage("media/screen.jpeg");
...
int initGST() {
	...
	! videorate name=rate ! image/jpeg,width=640,height=480,framerate=15/1 ! jpegdec ! queue \
   	! videoscale ! queue ! videoconvert ! video/x-raw,width=512,height=384,format=RGB,pixel-aspect-ratio=1/1 \
...
int main ( int argc, char **argv ) {
	...
	// carrega Simple2D
	window = S2D_CreateWindow("AAAA", 1920, 1080, update, render, 0);
